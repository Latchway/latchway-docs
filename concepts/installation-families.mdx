...
Delegation expiry, root trust expiry, user sign-out, component revocation,
family revocation, application or environment mismatch, and policy changes can
invalidate the relationship. Family revocation must invalidate every component
and its session family.
