...
| --- | --- |
| Docker Compose | Release image, explicit migration service, and PostgreSQL |
...
The private core source candidate contains reviewed Compose, Terraform,
Cloud Run YAML, Fly, and Cloudflare assets. Their static validation is source
evidence only; it is not proof that an operator account deployed them.
