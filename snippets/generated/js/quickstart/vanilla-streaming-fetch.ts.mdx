<Info>
  Generated from [examples/vanilla/streaming-fetch.ts](https://github.com/Latchway/latchway-js/blob/efa0a1074fd5639a02c4b852eac9ecaf4baf00f7/examples/vanilla/streaming-fetch.ts#L1-L93) at release `v1.0.0`. Bundle SHA-256: `f4e814289055bad88d508dde862ebdbd105b03483db807c2f128b0681da07711`.
</Info>
